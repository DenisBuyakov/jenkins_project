...
//                 '''
//
                sh "aws s3 rm s3://${env.AWS_S3_BUCKET}/jenkins-project-temp --recursive"
                ...
                sh "aws s3 mv s3://${env.AWS_S3_BUCKET}/jenkins-project-temp/ s3://${env.AWS_S3_BUCKET}/jenkins-project/ --recursive"
